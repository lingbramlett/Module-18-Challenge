Module 18 is this and below https://citibikenyc.com/system-data (edited)
Citi Bike System Data | Citi Bike NYC
Developers, engineers, statisticians and academics can find and download data on Citi Bike membership, ridership and trip histories.
...
Basic: A static map that plModule18ts all bike stations with a visual indication of the most popular locations to start and end a journey, with zip code data overlaid on top.
